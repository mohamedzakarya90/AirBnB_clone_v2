...
def __analyse(file_path):
    """ Staring analyse of file and print out result """
    nb_errors = 0
    try:
        result = None
...
def __files_loop():
    """ Looping analyses for each file from input arguments """
    nb_errors = 0
...
if __name__ == "__main__":
    ...
    """ Executting tests after that  exit. Exit status = # of errors (0 on success) """
